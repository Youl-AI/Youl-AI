...
- **[cited](https://github.com/Youl-AI/cited)** — 여러 LLM 답변에서 브랜드 언급률을 측정하는 파이프라인. 판정 모델은 수작업 골드셋으로 골랐습니다.
...
- **[byeolsaem](https://github.com/Youl-AI/byeolsaem)** — 천궁도 리포트 서비스. 정적 배포로 요청당 서버 비용을 없앴습니다.
